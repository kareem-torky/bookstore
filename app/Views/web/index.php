...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php asset('css/magnific-popup.css'); ?>">
    
    <link rel="stylesheet" href="<?php asset('css/flaticon.css'); ?>">
  ...
  <script src="<?php asset('js/jquery-migrate-3.0.1.min.js'); ?>"></script>
  <script src="<?php asset('js/popper.min.js'); ?>"></script>
  <script src="<?php asset('js/bootstrap.min.js'); ?>"></script>
  <script src="<?php asset('js/jquery.easing.1.3.js'); ?>"></script>
  <script src="<?php asset('js/jquery.waypoints.min.js'); ?>"></script>
  <script src="<?php asset('js/jquery.stellar.min.js'); ?>"></script>
  <script src="<?php asset('js/owl.carousel.min.js'); ?>"></script>
  <script src="<?php asset('js/jquery.magnific-popup.min.js'); ?>"></script>
  <script src="<?php asset('js/jquery.animateNumber.min.js'); ?>"></script>
  <script src="<?php asset('js/scrollax.min.js'); ?>"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="<?php asset('js/google-map.js'); ?>"></script>
